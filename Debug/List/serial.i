...
void uart_init(void)
{
  UBRRL = (((8000000L/(16*4800L)-1))& 0xFF);
  UBRRH = (((8000000L/(16*4800L)-1))>>8);
  UCSRA = ((0<<7)|     //USART Receive Complete
            (0<<6)|     //USART Transmit Complete
            (0<<5)|    //USART Data Register Empty
            (0<<4)|      //Frame Error
            (0<<3)|     //Data OverRun
            (0<<2)|      //USART Parity Error
            (0<<1)|     //Double the USART Transmission Speed
            (0<<0));   //Multi-processor Communication Mode 
  
  UCSRB = ((0<<7)|   //RX Complete Interrupt Enable
            (0<<6)|   //TX Complete Interrupt Enable
            (0<<5)|   //USART Data Register Empty Interrupt Enable
            (0<<4)|    //Receiver Enable
            (1<<3)|    //Transmitter Enable
            (0<<2)|   //Character Size
            (0<<1)|    //Receive Data Bit 8
            (0<<0));   //Transmit Data Bit 8
  
  UCSRC = ((1<<7)|   //Register Select
            (0<<6)|   //USART Mode Select
            (0<<5)|    //Parity Mode
            (0<<4)|    //Parity Mode
            (0<<3)|    //Stop Bit Select
            (1<<2)|   //Character Size
