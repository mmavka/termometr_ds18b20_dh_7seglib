...
{
  TCCR2 = 1<<3|4<<0; 			// Freq = CK/64 - Установить режим и предделитель
						// Автосброс после достижения регистра сравнения
  TCNT2 = 0;					// Установить начальное значение счётчиков
  OCR2  = (((8000000L/64/1000))& 0xFF); 			// Установить значение в регистр сравнения
  TIMSK = 0<<0|1<<7|0<<0;		// Разрешаем прерывание RTOS - запуск ОС
